    ...
    <div className="space-y-6 lg:space-y-8 max-w-[2560px] mx-auto animate-fade-in pb-10 relative 2xl:px-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate("/")}
            className="px-5 py-2.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-xl text-sm font-bold shadow-sm hover:shadow-md transition-all duration-200 flex items-center gap-2"
          >
                  ...
                  <tr key={task.id} className="group hover:bg-slate-50/50 transition-colors">
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-extrabold text-slate-800 text-sm">{task.projectName || "General Project"}</p>
                          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mt-1">{task.name} &bull; {task.category || "General"}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-6">
